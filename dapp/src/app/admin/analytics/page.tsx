...
export default function AnalyticsPage() {
  ...
  const { data: identityRequired } = useReadContract({
    address: GOOD_DROPS_ADDRESS,
    abi: GOOD_DROPS_ABI,
  ...
  const m = useMemo(() => {
    ...
    const maxClaimedWei = claimedDays.reduce(
      (mx, x) => (x.wei > mx ? x.wei : mx),
      1n,
    );
  ...
  return (
    ...
    >
      <div
        style={{ maxWidth: 900, margin: "0 auto", padding: "28px 18px 60px" }}
      >
        <h1
          style={{
            fontSize: 30,
        ...
        <p style={{ color: "#5a5a5a", fontSize: 14, marginBottom: 20 }}>
          Live from the subgraph + contract.
        </p>
        ...
        {!m ? (
          ...
          <>
            ...
            >
              ...
              <Stat
                label="Unique humans"
                value={String(m.humans)}
                sub="deduped by identity"
              />
              <Stat
                label="Hunters"
                value={String(m.hunters)}
                sub="claimed ≥ 1 drop"
              />
              <Stat
                label="Droppers"
                value={String(m.droppers)}
                sub="created ≥ 1 drop"
              />
            </div>
            ...
            >
              ...
              <Stat
                ...
                sub={`${m.expiredUnclaimed} expired unclaimed`}
              />
              <Stat
                label="Claimed"
                value={String(m.claimed)}
                sub={`${m.claimRate}% claim rate`}
              />
            ...
            >
              ...
              <Stat
                label="G$ reclaimed"
                value={formatG$(m.reclaimedWei)}
                sub="returned to droppers"
              />
            </div>
            ...
            >
              <Stat
                label="Active today"
                value={String(m.activeToday)}
                sub="hunters who claimed today"
                accent
              />
              <Stat
                label="Avg time-to-claim"
                value={fmtDuration(m.avgTtcSec)}
                sub="drop created → found"
              />
            </div>
            ...
            >
              <p style={{ margin: "0 0 14px", fontWeight: 900, fontSize: 15 }}>
                Drops created — last 14 days
              </p>
              <div
                style={{
              ...
              >
                {m.days.map(({ day, n }) => (
                  ...
                  >
                    <div
                      style={{ fontSize: 10, fontWeight: 800, color: "#888" }}
                    >
                      {n || ""}
                    </div>
                    <div
                      style={{
                        ...
                        border:
                          n > 0 ? "1.5px solid #111" : "1.5px solid #e0e0e0",
                ...
                {m.claimedDays.map(({ day, wei }) => {
                  ...
                  return (
                    <div
                      ...
                      title={`${day}: ${formatG$(wei)} G$`}
                    >
                      <div
                        style={{ fontSize: 9, fontWeight: 800, color: "#888" }}
                      >
                        {wei > 0n ? formatG$(wei) : ""}
                      </div>
                      <div
